...
<li class="{WPSHOP_PRODUCT_CLASS}" itemscope itemtype="http://data-vocabulary.org/Product" >
	<div class="bloc-item-padder">
		...
		<div class="product_information-mini-list bloc-item-content" itemprop="offers" itemscope itemtype="http://data-vocabulary.org/Offers">			
				...
				<a href="{WPSHOP_PRODUCT_PERMALINK}" title="{WPSHOP_PRODUCT_TITLE}" class="bloc-item-link wpshop_clearfix"></a>
