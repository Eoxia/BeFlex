...
/**
 * [cd_customizer_settings description]
 * @param  [type] $wp_customize [description]
 * @return [type]               [description]
 */
function beflex_customize_register( $wp_customize ) {

	$wp_customize->add_setting( 'beflex_primary_color', array(
			'default'           => '#0e6eff',
	...
	$wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'beflex_primary_color', array(
