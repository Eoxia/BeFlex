...
function eox_get_latest_posts( $atts = undefined ){
...
function eox_latest_posts_shortcode( $atts, $content = null ) {
	ob_start();
	eox_get_latest_posts($atts);
	return ob_get_clean();
}
add_shortcode( 'latest_posts', 'eox_latest_posts_shortcode' );
